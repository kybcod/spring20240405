...
public class Controller14 {
    ...
    public void sub2(Model model) {
        ...
        // attribute 명은 클래스명으로 lowerCamalCase로 변경된 이름으로 결정
        // myBean142
        // 이름을 생략하는 습관은 좋지 않음
    ...
    // /main14/sub8?name=son&age=33&address=london
    @RequestMapping("sub9")
    ...
    // /main14/sub10?name=강인&address=파리&age=23
    ...
    // city, country, price 프로퍼티가 있어야 한다.
    // 요청 파라미터를 바인딩 받는 메소드
    ...
    // /main14/sub12?car=tesla&price=200&model=k5$country=us
